...
export default function WorkshopPage({ onOpenStudio }: WorkshopPageProps) {
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-6 rounded-lg bg-white border border-gray-200 text-center">
          <div className="text-4xl mb-3">图</div>
        ...
        <button
          ...
          className="p-6 rounded-lg bg-white border border-gray-200 text-center hover:border-brand-300 hover:shadow-md transition-all disabled:opacity-60 disabled:cursor-not-allowed"
          disabled={!onOpenStudio}
        >
          <div className="text-4xl mb-3">片</div>
