...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-ink">⚙️ 家长设置</h1>
      ...
      <section className="mb-6">
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs text-ink-2">当前余额</div>
              <div className="text-3xl font-bold text-accent-ink mt-1">💎 {balance}</div>
        ...
        <Card>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className="text-ink-2">App 版本</span>
              <span className="font-mono text-ink">{version || '…'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-ink-2">设备 ID</span>
            ...
            <div>
              <div className="flex justify-between mb-1">
                <span className="text-ink-2">Secret 版本</span>
                <span className="font-mono text-ink text-xs">
