...
KidsAI Studio 是一款基于 **Tauri 2.0 + React 18** 的桌面客户端应用，目标用户为 **8-16 岁青少年**。通过 AI 引导式教学，让孩子在 20 个递进式关卡中学会用 AI 创作真实作品（视频、绘画、Agent），最终对接青少年 AI 素养等级认证。
...
- `docs/03-教学内容/` — 20 关卡脚本 + AI 助教 Prompt 库
